...
/*!
 * \brief The DiacriticIgnoringCompleter class is used for completion of strings containing
 * diacritics
...
class DiacriticIgnoringCompleter : public QCompleter {
  public:
    ...
    QStringList splitPath(const QString &path) const { return {normalise(path)}; }
    ...
    static constexpr int diacriticIgnoringRole() { return Qt::UserRole + 10; }

    static DiacriticIgnoringCompleter *createCompleter(const QStringList &completion_list,
