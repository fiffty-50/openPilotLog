...
class CurrencyWidget : public QWidget {
    ...
    QLabel *takeOffLandingHeaderLabel =
        new QLabel(tr("<b>Take-off and Landing Currency<\b>"), this);
    ...
    QLabel *takeOffLandingExpiryLabel =
        new QLabel(tr("3 Take-offs and Landings expiry date"), this);
